<p align="center">
  <a href="https://labex.io/learn/linux">
    <img width="160" src="https://file.labex.io/upload/u/1991/GXJSo2W4OcyY.png" alt="Learn Linux">
  </a>
</p>
...
Courses teach the workflow; projects help you prove you can use it. Open any project in a prepared LabEx environment and start building.

<details>
<summary><strong>Browse all 24 guided projects</strong></summary>

| # | Project | Level | Practice |
|---:|---|---|---|
| 1 | [Build a Linux System Monitor Using Bash](https://labex.io/courses/project-build-a-linux-system-monitor-using-bash) | Beginner | [Build project →](https://labex.io/courses/project-build-a-linux-system-monitor-using-bash) |
| 2 | [Build a Task Scheduler Using Bash](https://labex.io/courses/project-build-a-task-scheduler-using-bash) | Beginner | [Build project →](https://labex.io/courses/project-build-a-task-scheduler-using-bash) |
| 3 | [Installing and Configuring a Mail Server](https://labex.io/courses/project-installing-and-configuring-a-mail-server) | Beginner | [Build project →](https://labex.io/courses/project-installing-and-configuring-a-mail-server) |
| 4 | [Configuring SSH Certificates for Secure Login](https://labex.io/courses/project-certificate-configuration) | Beginner | [Build project →](https://labex.io/courses/project-certificate-configuration) |
| 5 | [Creating a Typing Game Using Bash](https://labex.io/courses/project-creating-a-typing-game-using-bash) | Beginner | [Build project →](https://labex.io/courses/project-creating-a-typing-game-using-bash) |
| 6 | [Linux Server Information Retrieval](https://labex.io/courses/project-get-system-information) | Beginner | [Build project →](https://labex.io/courses/project-get-system-information) |
| 7 | [Restore Access to Website](https://labex.io/courses/project-restore-access-to-website) | Beginner | [Build project →](https://labex.io/courses/project-restore-access-to-website) |
| 8 | [Searching for Specific Files](https://labex.io/courses/project-searching-for-specific-files) | Beginner | [Build project →](https://labex.io/courses/project-searching-for-specific-files) |
| 9 | [Automated Daily System Log Backup](https://labex.io/courses/project-log-backup) | Beginner | [Build project →](https://labex.io/courses/project-log-backup) |
| 10 | [Chess Board in Terminal](https://labex.io/courses/project-chess-board-in-terminal) | Intermediate | [Build project →](https://labex.io/courses/project-chess-board-in-terminal) |
| 11 | [Copy Large Files with Preserved Structure](https://labex.io/courses/project-copy-specified-files) | Beginner | [Build project →](https://labex.io/courses/project-copy-specified-files) |
| 12 | [Customizing Linux File Listing](https://labex.io/courses/project-directory-size) | Beginner | [Build project →](https://labex.io/courses/project-directory-size) |
| 13 | [New Colleague System Account Setup](https://labex.io/courses/project-new-colleague-system-account-setup) | Beginner | [Build project →](https://labex.io/courses/project-new-colleague-system-account-setup) |
| 14 | [Nginx Log Analysis and Optimization](https://labex.io/courses/project-log-analysis) | Beginner | [Build project →](https://labex.io/courses/project-log-analysis) |
| 15 | [Users and Groups Creation and Deletion Batch](https://labex.io/courses/project-bulk-creation-and-deletion-of-users-and-groups) | Beginner | [Build project →](https://labex.io/courses/project-bulk-creation-and-deletion-of-users-and-groups) |
| 16 | [Collect Files From Specified Time](https://labex.io/courses/project-collect-files-from-specified-time) | Beginner | [Build project →](https://labex.io/courses/project-collect-files-from-specified-time) |
| 17 | [Extracting Information From Text](https://labex.io/courses/project-extracting-information-from-text) | Beginner | [Build project →](https://labex.io/courses/project-extracting-information-from-text) |
| 18 | [Extracting Link Information From Text](https://labex.io/courses/project-extracting-link-information-from-text) | Beginner | [Build project →](https://labex.io/courses/project-extracting-link-information-from-text) |
| 19 | [Get Program That Satisfies the Condition](https://labex.io/courses/project-get-program-that-satisfies-the-condition) | Beginner | [Build project →](https://labex.io/courses/project-get-program-that-satisfies-the-condition) |
| 20 | [Implement Custom Trash-Enabled Command](https://labex.io/courses/project-avoid-accidental-deletion) | Beginner | [Build project →](https://labex.io/courses/project-avoid-accidental-deletion) |
| 21 | [Network Data Packet Statistics](https://labex.io/courses/project-network-data-packet-statistics) | Beginner | [Build project →](https://labex.io/courses/project-network-data-packet-statistics) |
| 22 | [Random Password Generator Development](https://labex.io/courses/project-password-generator) | Beginner | [Build project →](https://labex.io/courses/project-password-generator) |
| 23 | [Nmap Scanning and Telnet Access](https://labex.io/courses/project-nmap-port-scanning-and-telnet-access) | Beginner | [Build project →](https://labex.io/courses/project-nmap-port-scanning-and-telnet-access) |
| 24 | [FTP Enumeration and Anonymous Access](https://labex.io/courses/project-ftp-enumeration-and-anonymous-access) | Beginner | [Build project →](https://labex.io/courses/project-ftp-enumeration-and-anonymous-access) |

</details>

## Ready to begin?

[Start the complete Linux learning path on LabEx →](https://labex.io/learn/linux)
